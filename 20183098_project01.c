...
int main(){
    ...
    realloc(array,sizeof(int) * (arraySize));
	
    memmove(array+elementPosition,array+(elementPosition-1),(-elementPosition-1) * sizeof(int));
...
int main(){
	...
	if(elementPosition==0) array[0] = newElement;//첫번째 인덱스에 새 원소를 추가 할 경우 
	else array[elementPosition-1] = newElement;
...
//https://thrillfighter.tistory.com/145